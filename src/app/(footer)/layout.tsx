  ...
  return (
    <main className="min-h-screen text-amber-50 relative overflow-hidden">
      ...
      <div className="relative max-w-3xl mx-auto px-6 py-14">
        <div className="rounded-3xl bg-gradient-to-br from-stone-800/90 to-amber-900/60 backdrop-blur border border-amber-700/40 shadow-2xl shadow-amber-900/40 p-8 md:p-10">
          {children}
        </div>
      </div>
    </main>
